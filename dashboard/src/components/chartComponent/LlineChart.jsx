...
const Filter = ({ options, onChange, selectedValue, label }) => {
    return (
      <div>
        <label>{label}</label>
...
const LlineChart = () => {
    ...
    const renderChart = () => {
        ...
        xScale.domain([0, d3.max(filteredData, d => d.intensity)]).nice();
        yScale.domain([0, d3.max(filteredData, d => d.likelihood)]).nice();
    ...
    return (
        <div>
            ...
            <div className='filter-dv'>
                <Filter
                    options={[/* List of unique years in your data */]}
                    onChange={setSelectedYear}
                    selectedValue={selectedYear}
                    label="Year"
                />
                <Filter
                    options={[/* List of unique countries in your data */]}
                    onChange={setSelectedCountry}
                    selectedValue={selectedCountry}
                    label="Country"
                />
                <Filter
                    options={[/* List of unique topics in your data */]}
                    onChange={setSelectedTopic}
                    selectedValue={selectedTopic}
                    label="Topic"
                />
                <Filter
                    options={[/* List of unique regions in your data */]}
                    onChange={setSelectedRegion}
                    selectedValue={selectedRegion}
                    label="Region"
                />
                <Filter
                    options={[/* List of unique cities in your data */]}
