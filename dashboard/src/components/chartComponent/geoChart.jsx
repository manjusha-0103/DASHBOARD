...
const GeoChart = (props) => {
    //console.log("geochart : ", data)
    const chartData = [['Country', 'Sector', 'Intensity']];
    props.props.forEach(item => {
        chartData.push([item.country, item.sector, item.intensity]);
      });
    return (
        <div style={{width : "100%"}}>
            <h2>Intensity of Sectors in each country</h2>
            <Chart
                width={'100%'}
                height={'400px'}
                chartType="GeoChart"
                ...
                options={{
                    chart :{
                        title : "Intensity of Countries in each country"
                    }, 
                    colorAxis :{
                        colors: ["#5032a8"]
                    },
