...
const Line = (props) => {
    ...
    const chartData = [
        ['source', 'Intensity', 'likelihood','relevence'],
    ...[...new Set(props.props.map(item => item.source))]
        .map(uniqueSource => {
            // Find the corresponding items for each unique source
            const itemsForSource = props.props.filter(item => item.source === uniqueSource);
            ...
            return [uniqueSource, aggregatedIntensity, aggregatedLikelihood,aggregatedRelevance];
        })
    ];
      ...
      return (
        <Chart
          ...
          data={chartData}
          options={{
            colors : ["#a08be0","#f00c17","#230d38"],
            title: 'Intensity ,LikelyHood by Source',
            hAxis: { title: 'Source', titleTextStyle: { color: '#333',  },minValue:1 ,scaleType: 'log'},
            vAxis: { title:"Intensity Vs Likelyhood",minValue: 0 },
